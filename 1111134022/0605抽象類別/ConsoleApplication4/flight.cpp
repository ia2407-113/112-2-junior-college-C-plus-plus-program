...
int airliner::afterburnner()
{
    return 0;
}

int battleplane::afterburnner()
{
    return afterburnner_time;
}
...
void battleplane::create_flight_object()
{
    ...
    cin >> kerosene;
    cout << "後燃器秒數時間(秒)";
    cin >> afterburnner_time;
}
  
void battleplane::display()
{
    int temp = battleplane::afterburnner();
