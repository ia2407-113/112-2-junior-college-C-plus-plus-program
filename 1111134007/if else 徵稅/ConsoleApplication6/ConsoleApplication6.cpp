...
int main()
{
    ...
    cin >> money;
	if (money <= 560000)
		cout << "合適級距為5%, 應納稅額" << money * 0.05;
	else if (money >= 560001 && money <= 1260000)
		cout << "合適級距為12%, 應納稅額" << money * 0.12 - 39200;
	else if (money >= 1260001 && money <= 2520000)
	    cout << "合適級距為20%, 應納稅額" << money * 0.2-140000;
	else if (money >= 2520001 && money <= 4720000)
	     cout << "合適級距為30%, 應納稅額" << money * 0.3-392000;
	else if (money >= 4720001 )
	     cout << "合適級距為40%, 應納稅額" << money * 0.4-864000;
	return 0;
}
